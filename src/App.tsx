      ...
      if (parsedData && typeof parsedData === 'object') {
        try {
          ...
          const mappedData: ResumeData = {
            personalInfo: {
              name: parsedData.resume.name || parsedData.resume.personalInfo?.name || 'Your Name',
              title: parsedData.title || parsedData.resume.personalInfo?.title || 'Your Title',
              email: parsedData.email || parsedData.resume.personalInfo?.email || 'your.email@example.com',
              phone: parsedData.phone || parsedData.resume.personalInfo?.phone,
              location: parsedData.location || parsedData.resume.personalInfo?.location || 'Your Location',
              linkedin: parsedData.linkedin || parsedData.resume.personalInfo?.linkedin,
              github: parsedData.github || parsedData.resume.personalInfo?.github,
              website: parsedData.website || parsedData.resume.personalInfo?.website
            },
            summary: parsedData.summary || parsedData.resume.about || 'Your professional summary...',
            experience: parsedData.resume.experience || [],
            education: parsedData.resume.education || [],
            skills: parsedData.resume.skills || [],
            projects: parsedData.resume.projects || []
          };
